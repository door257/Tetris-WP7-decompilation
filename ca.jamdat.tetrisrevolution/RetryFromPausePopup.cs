...
{
	public class RetryFromPausePopup : Popup
	{
		public RetryFromPausePopup(BaseScene baseScene, Softkey selectSoftKey, Softkey clearSoftKey)
		...
		{
			base.Load();
			mContentMetaPackage = GameLibrary.GetPackage(491535);
		}
